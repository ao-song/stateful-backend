...
pub struct VerKvPair {
    #[prost(message, optional, tag="1")]
    pub error: ::core::option::Option<VerError>,
    #[prost(bytes="vec", tag="2")]
    pub key: ::prost::alloc::vec::Vec<u8>,
    #[prost(message, optional, tag="3")]
    pub value: ::core::option::Option<VerValue>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VerGetRequest {
    ...
    #[prost(bytes="vec", tag="2")]
    pub key: ::prost::alloc::vec::Vec<u8>,
    /// start_version == 0 means without start version
    #[prost(uint64, tag="3")]
    pub start_version: u64,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct VerBatchGetResponse {
    ...
    pub region_error: ::core::option::Option<super::errorpb::Error>,
    #[prost(message, repeated, tag="2")]
    pub pairs: ::prost::alloc::vec::Vec<VerKvPair>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VerMutRequest {
    ...
    pub context: ::core::option::Option<Context>,
    #[prost(message, optional, tag="2")]
    pub r#mut: ::core::option::Option<VerMutation>,
    #[prost(uint64, tag="3")]
    pub version: u64,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct VerBatchMutRequest {
    ...
    pub context: ::core::option::Option<Context>,
    #[prost(message, repeated, tag="2")]
    pub muts: ::prost::alloc::vec::Vec<VerMutation>,
    #[prost(uint64, tag="3")]
    pub version: u64,
}
#[derive(Clone, PartialEq, ::prost::Message)]
